<div>
    ...
    >
        ...
        <div class="p-6 space-y-8 relative">
            {{-- Disabled Overlay for unsaved items --}}
            @if (!$itemId)
                <div class="absolute inset-x-0 inset-y-0 z-20 flex flex-col items-center justify-center bg-white/60 dark:bg-gray-800/60 backdrop-blur-[2px] rounded-b-2xl px-6 text-center">
                    <div class="p-4 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-violet-100 dark:border-violet-900/50 flex flex-col items-center gap-3 max-w-sm">
                        <div class="w-12 h-12 bg-violet-100 dark:bg-violet-900/30 rounded-full flex items-center justify-center">
                            <x-lucide-lock class="w-6 h-6 text-violet-600" />
                        </div>
                        <div>
                            <h4 class="font-bold text-gray-900 dark:text-white">Upload Belum Tersedia</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Silakan simpan item terlebih dahulu (Klik tombol Create Item/Update Item) untuk mengaktifkan fitur upload.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="{{ !$itemId ? 'opacity-40 grayscale pointer-events-none select-none' : '' }}">
