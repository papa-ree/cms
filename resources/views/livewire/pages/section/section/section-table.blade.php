            ...
            @foreach ($this->availableSections as $section)
                <tr wire:key='section-{{ $section->slug }}'>
                    ...
                    <td class="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell">
                        <span class="block text-sm text-gray-500">{{ $section->type }}</span>
                    </td>

                    <td class="hidden px-3 py-4 text-sm text-gray-500 md:table-cell">
                        <span class="block text-sm text-gray-500">{{ $section->usage }}</span>
                    </td>

                    <td class="hidden px-3 py-4 text-sm text-gray-500 md:table-cell">
                        <span class="block text-sm text-gray-500">{{ $section->created_at }}</span>
                    </td>
