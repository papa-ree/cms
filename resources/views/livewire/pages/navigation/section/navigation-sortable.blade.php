<div x-data="{
    ...
    <div
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Navigation Hierarchy Manager (Beta
                    Feature)</h3>
                <p class="text-sm text-gray-700 dark:text-gray-300 mb-3">
                    Organize your navigation menu with drag-and-drop. Reorder cards or move sub-items between different
                    parents.
                </p>
                <div class="grid gap-2 md:grid-cols-2">
                    ...
                    <div class="flex items-start gap-2">
                        <x-lucide-check class="w-4 h-4 text-indigo-600 mt-0.5" />
                        <span class="text-sm text-gray-600 dark:text-gray-400">Move sub-items within or between
                            cards</span>
                    </div>
                </div>
            </div>
    ...
    <div x-show="hasLocalChanges" x-transition:enter="transition ease-out duration-300"
        ...
        <div
            ...
            <span class="text-sm font-semibold text-purple-700 dark:text-purple-400">Unsaved Changes</span>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <button @click="handleSave()" :disabled="$wire.isSaving"
                ...
                <span wire:loading.remove wire:target="saveAllChanges">Save Changes</span>
                <span wire:loading wire:target="saveAllChanges">Saving...</span>
            </button>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6" id="parent-grid">
            @foreach($this->availableNavigations as $index => $navigation)
                <div class="parent-card bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col"
                    ...
                    <div
                        class="p-6 bg-gradient-to-r from-purple-50/50 to-indigo-50/50 dark:from-purple-900/10 dark:to-indigo-900/10">
                                    ...
                                    <div class="flex items-center gap-3 mb-1.5">
                                        ...
                                        @if($navigation->children_count > 0)
                                            <span
                                                ...
                                                sub-item{{ $navigation->children_count > 1 ? 's' : '' }}
                                            </span>
                                        @endif
                                    </div>
