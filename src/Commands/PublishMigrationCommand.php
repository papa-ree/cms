...
class PublishMigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cms:publish-migration';
     ...
     * @var string
     */
    protected $description = 'Publish migrations from Bale CMS with options (All, Auto, or Specific)';
    ...
    public function handle(): int
    {
        ...
        if (empty($migrations)) {
            $this->warn("No migrations found in the CMS package.");
            return self::SUCCESS;
        }

        $this->info("Bale CMS Migration Publisher");
